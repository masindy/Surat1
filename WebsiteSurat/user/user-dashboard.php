    ...
    <h2>Form Permohonan</h2>
      <form action="proses.php" method="post">
          ...
          <select id="surat" name="surat" required>
                <option value=""disabled selected default>Pilih Jenis Surat</option>
                <option value="surat1">Surat Aktif Studi</option>
                <option value="surat2">Surat Cuti Studi</option>
                <option value="surat3">Surat Berhenti Studi</option>
          </select>
          </div>
